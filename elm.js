...
var $author$project$Home$Landing = function (a) {
	return {$: 'Landing', a: a};
};
var $author$project$Home$Search = function (city) {
	return {city: city};
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Home$init = function (_v0) {
	var newSearch = $author$project$Home$Search('');
	return _Utils_Tuple2(
		$author$project$Home$Landing(newSearch),
...
var $author$project$Home$Loading = {$: 'Loading'};
...
var $author$project$Home$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'City':
				var city = msg.a;
				var cityToSearch = $author$project$Home$Search(city);
				return _Utils_Tuple2(
			...
			case 'GotWeather':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var decodedWeather = result.a;
					return _Utils_Tuple2(
						$author$project$Home$Success(decodedWeather),
						$elm$core$Platform$Cmd$none);
				} else {
					var err = result.a;
					return _Utils_Tuple2(
			...
			default:
				...
				return _Utils_Tuple2(
					$author$project$Home$Landing(resetSearch),
					$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Home$failure = function (err) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'color', '#DA2C38'),
				$elm$html$Html$Attributes$class('text-xl my-5')
			]),
		_List_fromArray(
			[
...
var $author$project$Home$inputSection = function (search) {
	return A2(
		$elm$html$Html$input,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-1/2 appearance-none bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500'),
...
var $perzanko$elm_loading$Loading$Sonar = {$: 'Sonar'};
...
var $author$project$Home$loading = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			$perzanko$elm_loading$Loading$Sonar,
			_Utils_update(
...
var $author$project$Home$icon = function (iconName) {
	var iconPath = './assets/svg/' + (iconName + '.svg');
	return A2(
		$elm$html$Html$img,
		_List_fromArray(
			[
...
var $author$project$Home$shortMessage = function (message) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Home$weather = function (weatherData) {
	var windMessage = (weatherData.wind.speed < 10) ? 'The wind is meh.' : (A2(
		$elm$core$List$member,
		$elm$core$Basics$round(weatherData.wind.speed),
		A2($elm$core$List$range, 10, 30)) ? 'The wind is interesting.' : (A2(
		$elm$core$List$member,
		$elm$core$Basics$round(weatherData.wind.speed),
		A2($elm$core$List$range, 30, 50)) ? 'The wind is strong!' : 'The wind is trying to blow your house away!'));
	var newIcon = function () {
		var _v0 = weatherData.description._short;
		if (_v0 === 'Clouds') {
			return 'cloud';
		} else {
			return 'sun';
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('max-w-sm rounded overflow-hidden shadow-lg')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$src('./assets/svg/undraw_nature_fun_n9lv.svg')
							]),
						_List_Nil),
						A2(
						$elm$html$Html$div,
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('font-bold text-xl flex flex-row items-center justify-center mb-2')
									]),
								_List_fromArray(
									[
										$author$project$Home$icon(newIcon),
										A2(
										$elm$html$Html$span,
										_List_fromArray(
											[
												A2($elm$html$Html$Attributes$style, 'color', '#475B63'),
												$elm$html$Html$Attributes$class('text-5xl ml-5')
											]),
										_List_fromArray(
											[
												$elm$html$Html$text(
												$elm$core$Debug$toString(weatherData.temperatures.now)),
												$elm$html$Html$text(
								...
								_List_fromArray(
									[
										$author$project$Home$shortMessage(windMessage),
										$author$project$Home$shortMessage(
										'Pressure is at ' + ($elm$core$Debug$toString(weatherData.other.pressure) + '.')),
										$author$project$Home$shortMessage(
										'Humidity is at ' + ($elm$core$Debug$toString(weatherData.other.humidity) + '%.'))
									])),
								A2(
								$elm$html$Html$div,
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('text-center text-xl my-5'),
										A2($elm$html$Html$Attributes$style, 'color', '#475B63')
									]),
								_List_fromArray(
									[
...
var $author$project$Home$weatherPage = function (innerHtml) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Home$view = function (model) {
	switch (model.$) {
		...
		case 'Success':
			...
			return $author$project$Home$weatherPage(
